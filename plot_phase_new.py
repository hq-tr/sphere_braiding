...
m, b = np.polyfit(Omega2[-4:], Lz2[-4:],1) # fit y = mx + b for the last 4 points of data
print(f"m = {m}")
Lz2_mod = Lz2 - Lz2[0] - Omega2*(m+aa.shift) # Here Nϕ = Nₒ
...
plt.savefig(f"plots/linearfit_Lz_{Ne}e{No}.svg")
